                ...
                <div class="col-md-12">
                    <div class="footer-section">
                        ...
                        <div class="footer-item">
                            <h2 class="footer-heading mb-4 off-white" style="color:white;">Quick Links</h2>
                            <ul class="list-unstyled">
                                <li style="color:white;"><a href="{{ route('home') }}" style="color:white;">Home</a></li>
                                <li style="color:white;"><a href="{{ route('about') }}" style="color:white;">About</a></li>
                                <li style="color:white;"><a href="{{ route('contact-us') }}" style="color:white;">Contact Us</a></li>
                            </ul>
                        </div>

                        <!-- Contact Section -->
                        <div class="footer-item">
                            <h2 class="footer-heading mb-4 off-white" style="color:white;">Contact</h2>
                            <ul class="list-unstyled">
                                <li>
                                    <a href="tel:9746222668">
                                        <p class="lead off-white" style="color:white;">+91 97462 22668</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="footer-item follow-us">
                            <div>
                                <h2 class="footer-heading mb-4 off-white" style="color:white;">Follow Us&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
