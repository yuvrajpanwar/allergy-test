    ...
    <div class="site-section block-services-1"
        ...
        <div class="container" style="max-width: 100%; padding: 0 15px;">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <img src="{{ asset('/public/images/whatsapp/cough480x320.png') }}" alt="Itching Image"
            ...
            <div class="text-center" style="margin-top: 20px;">
                <p
                    ...
                    Asthma and allergy coughs are typically caused by swelling or irritation of the airways. Allergies
                    like hay fever can cause a chronic dry cough. If you're sensitive to dust, pet dander, pollen, mold,
                    some food items or other common allergens, then your allergy symptoms may include a cough. Chronic
                    allergies, hyperactive gag reflex, and acid reflux can create a prolonged irritation in your throat
                    and cause an ongoing cough.
                    <br><br>
                    A cough caused by allergies can be similar to a cough caused by a cold, but they may differ in
                    subtle ways. A cough caused by allergies is usually dry and may feel like an itch or tickle in your
                    throat. Coughs caused by colds tend to be wet and productive, which means you will cough up mucus.
                    <br><br>
                    Antihistamines, nasal sprays, and decongestants are a few of the remedies that can help relieve an
                    allergy cough.
                    <br><br>
                    An allergy can also set off asthma symptoms, triggering cough and other breathing problems.With
                    asthma, you are more likely to experience chest tightness, shortness of breath, and wheezing due to
                    the narrowing of the airways of the lungs.
                </p><br>
