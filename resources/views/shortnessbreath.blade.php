    ...
    <div class="site-section block-services-1"
        ...
        <div class="container" style="max-width: 100%; padding: 0 15px;">
            <div class="row align-items-left justify-content-between flex-column flex-lg-row">
                ...
                <div class="col-lg-7 col-md-12 mb-4 mb-lg-0 custom-heading">
                    <h2 class="mb-3 mt-0 text-dark"
                        ...
                        ALLERGY SYMPTOMS<br>Shortness of Breath
                    </h2>
                </div>
            ...
            <div class="text-center" style="margin-top: 20px;">
                <img src="{{ asset('/public/images/whatsapp/short480x320.png') }}" alt="Itching Image"
            ...
            <div class="text-center" style="margin-top: 20px;">
                <p
                    ...
                    Shortness of breath may be triggered by some common foods that some people are allergic to such as
                    eggs, milk, nuts, shellfish, and wheat. Things in the air that can set off your allergies are dust,
                    pollen, and pet dander, tiny pieces of skin that are shed by cats, dogs, and other animals.
                    Shortness of breath, or breathlessness, is when a person has trouble taking in enough air to
                    breathe. It can range from mild to severe.
                    <br><br>
                    Shortness of breath is often described as an intense tightening in the chest, air hunger, difficulty
                    breathing, breathlessness or a feeling of suffocation. Very strenuous exercise, extreme
                    temperatures, obesity and higher altitude all can cause shortness of breath in a healthy person.
                    <br><br>
                    Asthma symptoms like shortness of breath are often closely linked to allergies and exposure to
                    allergic triggers, such as ragweed, pollen, animal dander or dust mites. Irritants in the air like
                    smoke, chemical fumes, strong odours or extreme weather conditions can also be triggers.
                </p><br>
