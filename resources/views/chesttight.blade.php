    ...
    <div class="site-section block-services-1"
        ...
        <div class="container" style="max-width: 100%; padding: 0 15px;">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <img src="{{ asset('/public/images/whatsapp/chest480x320.png') }}" alt="Itching Image"
            ...
            <div class="text-center" style="margin-top: 20px;">
                <p
                    ...
                    Chest tightness: Seasonal allergies are extremely common and often uncomfortable, but when should
                    you see a doctor? ... Even so, downplaying the condition can make it easy to ignore signs of serious
                    allergies, such as chest tightness and difficulty breathing, which require medical attention. Asthma
                    mainly affects your lungs, and may cause coughing, wheezing, chest tightness, shortness of breath or
                    rapid breathing. Undetected allergy can cause asthma in the longterm.
                    <br><br>
                    Tightness in the chest can be caused by multiple issues. Reasons include infection, injury, anxiety,
                    cardiovascular conditions, lung conditions, and digestive issues. If you feel like your chest is
                    tightening, you may worry that you're having a heart attack.<br>
