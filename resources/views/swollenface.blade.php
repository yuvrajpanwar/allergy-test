    ...
    <div class="site-section block-services-1" style="background-image: url('http://localhost/allergy-test/public/images/whatsapp/Group35.png'); height:auto; background-repeat: no-repeat; background-size: cover;">
        <div class="container" style="max-width: 100%; padding: 0 15px;">
            <div class="row align-items-left justify-content-between">
                ...
                <div class="col-lg-7 mb-4 mb-lg-0 custom-heading">
                    <h2 class="mb-3 mt-0 text-dark" style="font-family: 'Francois One', sans-serif; font-size: 28px; font-weight: 400; line-height: 1.4; text-align: left;">
                        ALLERGY SYMPTOMS<br>Face Swelling
                    </h2>
                </div>
            ...
            <div class="text-center" style="margin-top: 20px;">
                <img src="http://localhost/allergy-test/public/images/whatsapp/face480x320.png" alt="Itching Image" style="width: 100%; max-width: 555px; height: auto; display: block; margin: 0 auto;">
            </div>
            ...
            <div class="text-center" style="margin-top: 20px;">
                <p style="width: 100%; max-width: 555px; margin: 0 auto; font-family: Francois One, sans-serif; font-size: 18px; font-weight: 400; line-height: 1.6; text-align: left;">
                    ...
                    <br><br>
                    Allergies<br>
                    Your face may swell due to different allergies you may or may not be aware of.<br><br>

                    Food allergy: Allergic reactions to food can present with swelling to the face, lips, or tongue. The reaction may also cause hives, wheezing or respiratory distress, vomiting or diarrhoea. If you are concerned about an allergic reaction, seek emergency medical attention.<br>
                    Medication allergy: Allergic reactions to medications can present with swelling to face, lips, or tongue. The reaction may also cause hives, wheezing, respiratory distress, vomiting, or diarrhoea. Sometimes people develop allergic reactions to medications they have been taking for a long time. If you are concerned about an allergic reaction, seek emergency medical attention.<br>
