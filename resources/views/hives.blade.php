    ...
    <div class="site-section block-services-1"
        ...
        <div class="container" style="max-width: 100%; padding: 0 15px;">
            ...
            <div class="text-center" style="margin-top: 20px;">
                <img src="{{ asset('/public/images/whatsapp/hives480x320.png') }}" alt="Itching Image"
            ...
            <div class="text-center" style="margin-top: 20px;">
                <p
                    ...
                    Hives are raised welts on the skin that appear in varying shapes and sizes. Although hives are very
                    common, their cause is often elusive. Hives can change size rapidly and move around, disappearing in
                    one place and reappearing in other places, often in a matter of hours. Ordinary hives flare up
                    suddenly and might go away in sometime,
                    <br><br>
                    Hives is a common skin rash triggered by many things, including certain foods, medication and
                    stress.
                    <br><br>
                    Symptoms include itchy, raised, red or skin-coloured welts on the skin's surface.
                    <br><br>
                    Hives usually go away without treatment, but antihistamine medication is often helpful in improving
                    symptoms.
                    <br><br>
                    Hives typically occur as an allergic response to something in your environment or something you
                    ate.
                    <br><br>
                    When you have an allergic reaction, your body begins to release histamines into your blood.
                    Histamines are chemicals your body produces in an attempt to defend itself against infection and
                    other outside intruders.
                    <br><br>
                    Unfortunately, in some people, the histamines can cause swelling, itching, and many of the symptoms
                    that are experienced with hives. In terms of allergens, hives can be caused by factors such as
                    pollen, medications, food, animal dander, and insect bites.
                    <br><br>
