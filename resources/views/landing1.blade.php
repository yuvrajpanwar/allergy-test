            ...
            <div class="row align-items-center">
                <div class="col-11 col-xl-4">
                    <h1 class="mb-0 site-logo">
                        <a href="{{ route('home') }}" class="text-white mb-0">
                            <img style="max-height: 65px; margin: 10px 0;" src="{{ asset('public/images/whatsapp/mainlogo.png') }}" alt="Logo">
                        </a>
                    </h1>
                </div>
                <div class="col-12 col-xl-8 text-content">
                    <p class="city-info">
                        ...
                        <a href="https://wa.me/7358728170" style="text-decoration:none;">Click here to Chat with us now</a> or
                        Call us Now: <strong><a href="tel:+919746222668" style="text-decoration:none; color: #ff3300;"> 97462 22668</a></strong>
                    </p>
                </div>
            </div>
        </div>
